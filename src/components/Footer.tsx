...
const Footer = () => {
  ...
  <footer >
    <div className=' h-[1px] w-full bg-slate-300 '></div>
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8  mt-10 ">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <span>Laundry</span><span>CT</span>
        ...
        <div className="flex mt-8 ml-14 space-x-6 text-gray-600">
      ...
      <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
           <Link className="hover:opacity-75" to="/"> Premium washing  </Link>
           <Link className="hover:opacity-75" to="/"> Dry Cleaning </Link>
           <Link className="hover:opacity-75" to="/"> Organic Washing </Link>
        ...
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
           ...
           <Link className="hover:opacity-75" to="/"> Service </Link>
           <Link className="hover:opacity-75" to="/"> Price </Link>
          </nav>
        </div>
        <div>
          <p className="font-medium">
